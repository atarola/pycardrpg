...
Skills are task specific aptitudes a unit has, which grant additional Action Cards to the unit's pool.

h3. Experience Points

Units are awarded Experience Points for defeating enemies and completing tasks that move them closer to their goal.  These Experience Points can be spent either on better Attributes, or on Skills.
